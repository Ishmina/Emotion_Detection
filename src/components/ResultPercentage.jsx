//resultinpercentage.jsx

import React from "react";

const emotions = [
  { name: "Sad", emoji: "🥲", color: "bg-blue-500 border-blue-600 text-blue-100", value: 35 },
  { name: "Joy", emoji: "😄", color: "bg-yellow-400 border-yellow-500 text-yellow-100", value: 50 },
  { name: "Anger", emoji: "😡", color: "bg-red-500 border-red-600 text-red-100", value: 15 },
  { name: "Fear", emoji: "😱", color: "bg-purple-500 border-purple-600 text-purple-100", value: 25 },
  { name: "Love", emoji: "🩷", color: "bg-pink-500 border-pink-600 text-pink-100", value: 40 },
  { name: "Surprise", emoji: "😯", color: "bg-teal-500 border-teal-600 text-teal-100", value: 20 },
];
        ...
        {predictions.map((emotion, idx) => (
          <div key={idx} className="transition-all duration-300 hover:shadow-lg rounded-xl p-4 bg-pink-50">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-xl font-semibold  text-pink-950">{emotion.value}%</span>
            </div>
